...
type PrismProps = {
  height?: number;
  baseWidth?: number;
  animationType?: 'rotate' | 'hover' | '3drotate' | 'rotate3d';
  glow?: number;
...
const Prism: React.FC<PrismProps> = ({
  ...
  useEffect(() => {
    ...
    const normalizedAnimationType = animationType === 'rotate3d' ? '3drotate' : animationType;
    ...
    if (normalizedAnimationType === 'hover') {
    ...
    } else if (normalizedAnimationType === '3drotate') {
      program.uniforms.uUseBaseWobble.value = 0;
    } else {
